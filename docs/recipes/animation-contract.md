...
U7 PASS <the baked clip drives the imported rig and the skin follows>
...
| `U7 FAIL <details>` | The clip did not move the imported rig/skin as its own curves predict. | Check bone hierarchy paths and the exported action, then re-export. |
